...
# Author: Drew Cross
#
# Example: .\Enable-NestedVm.ps1 "Win10_Docker_Demo"
#           & "C:\Users\Chris\SkyDrive\Work\Development\GitHub\docker\Presentations\Introduction to Containers\Demos\Scripts\Enable-NestedVm.ps1" "Win10_Docker_Demo"
